            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                       <div class="panel-heading">
                           <h3 class="panel-title">Vehicles due for unclamping </h3>
                       </div>
                        ...
                        <div class="page-content-wrap">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <form class="date_form_container" method="POST" action="{{ route('filtertounclamp') }}">
                                                @csrf
                                        ...
                                        <div class="panel-body">
                                            <table id="customers2" class="table datatable">
                                                ...
                                                @endphp
                                                @foreach ($tounclamp->paginatedList as $key=>$item)
                                                    <tr>
                                                        <td>{{ $key+1 }}</td>
