            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Off-Street Parking for (Sanken, High Court & Country Bus)</h3>
                       </div>
                        ...
                        <div class="page-content-wrap">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <form class="date_form_container" method="POST" action="{{ route('filteroffstreet') }}">
                                                @csrf
                                        ...
                                        <div class="panel-body">
                                            <table id="customers2" class="table datatable">
                                                ...
                                                <tbody>
                                                @foreach ($offstreet->paginatedList as $key=>$item)
                                                    <tr>
                                                        <td>{{ strtoupper($item->vehicle_reg_no) }}</td>
                                                        @if ($item->zone_code == 'SUNKEN_OFFSTREET')
                                                            <td>SUNKEN</td>
                                                            @elseif ($item->zone_code == 'OFFSTREET_HIGH_COURT')
                                                                <td>HIGH COURT</td>
                                                            @else
                                                            <td>COUNTRY BUS</td>
                                                        @endif
