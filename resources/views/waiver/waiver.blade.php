                        ...
                        <div class="page-content-wrap">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <form class="date_form_container" method="POST" action="{{ route('filterwaiver') }}">
                                                @csrf
                                        ...
                                        <div class="panel-body">
                                            <table id="customers2" class="table datatable">
                                                ...
                                                <tbody>
                                                @foreach ($cWaiver->paginatedList as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('remark', [$item->vehicle_reg_no, $item->waiver_reason]) }}" class="btn btn-success btn-xs" role="button">Waiver</a>
                                                        </td>
                                                    </tr>
                                                @endforeach()
                                                </tbody>
