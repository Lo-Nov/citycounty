        ...
        <div class="main-content">
            <div class="content-heading clearfix">
                <div class="heading-left">
                    <h1 class="page-title"> Requested Waivers</h1>
                </div>
                <ul class="breadcrumb">
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <ul class="nav nav-tabs nav-tabs-right">
                        <li class="active"><a href="#tabitem1" data-toggle="tab">Waiver Vehicle <span class="badge"></span></a></li>
                    </ul>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <table id="example" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                        @foreach ($cWaiver->response_data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('remark', [$item->vehicle_reg_no, $item->description]) }}" class="btn btn-success btn-xs" role="button">Waiver</a>
