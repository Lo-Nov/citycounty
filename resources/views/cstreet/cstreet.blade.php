            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <ul class="nav nav-tabs nav-tabs-right">
                        <li class="active"><a href="#tabitem1" data-toggle="tab">Streets Collections<span class="badge"></span></a></li>
                    </ul>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <table id="example" class="table table-striped table-hover">
                                        ...
                                        @endphp
                                        @foreach ($sRange->collection_list as $key=>$item)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $item->par1 }}</td>
                                                <td style="text-align: right">{{ $item->par2 }}
                                                    @php($total += $item->par2)</td>
                                            </tr>
                                        @endforeach()
                                        </tbody>
                                    </table>
