            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <ul class="nav nav-tabs nav-tabs-right">
                        <li class="active"><a href="#tabitem1" data-toggle="tab">Hourly <span class="badge">12</span></a></li>
                        <li ><a href="#tabitem2" data-toggle="tab">Daily <span class="badge element-bg-color-orange">3</span></a></li>
                        <li><a href="#tabitem3" data-toggle="tab">Location <div class="label label-success"><i class="fa fa-arrow-up"></i> 3.5%</div></a></li>
                    </ul>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <table id="example" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                        @foreach ($hourfilter->total_queries_list as $item)
                                            <tr>
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <table id="example4" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                        @foreach ($zonefilter->total_queries_list as $item)
                                            <tr>
                                                <td>{{ $item->headerName }}</td>
                                                <td>{{ $item->number }}</td>
                                                <td>{{ date('d-m-Y g:i a', strtotime($item->date)) }}</td>
