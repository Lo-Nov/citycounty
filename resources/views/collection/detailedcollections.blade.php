                ...
                <div class="panel-body">
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="tabitem1">
                            ...
                            <div class="panel">
                                <div class="panel-body">
                                            ...
                                            <div class="col-md-2">
                                                <div class="dropdown"><span>Sub County</span>
                                                    <select class="form-control" name="subcounties" id="countries">
                                                        ...
                                                        @foreach($detailsCollections->subcounties as $key=>$value )
                                                            <option >{{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-2">
                                                <div class="dropdown">
                                                    ...
                                                    <select class="form-control" name="zones" id="countries">
                                                        ...
                                                        @foreach($detailsCollections->zones as $key=>$value )
                                                            <option>{{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-2">
                                                <div class="dropdown">
                                                    ...
                                                    <select class="form-control" name="agents" id="countries">
                                                        ...
                                                        @foreach($detailsCollections->agents as $key=>$value )
                                            ...
                                            <div class="col-md-2">
                                                <div class="dropdown">
                                                    ...
                                                    <select class="form-control" name="streets" id="countries">
                                                        ...
                                                        @foreach($detailsCollections->streets as $key=>$value )
                                                            <option>{{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <table id="example" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                        @foreach ($detailsCollections->total_queries_list as $key=> $item)
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                            ...
                            for ($x = 1; $x <= $pay; $x++) {?>
                            <a href="{{route('dpages',$x)}}" class="btn btn-default btn-xs" role="button">{{ $x }} &raquo;</a>
                            <?php
                            }
                            ?>
                                </div>
